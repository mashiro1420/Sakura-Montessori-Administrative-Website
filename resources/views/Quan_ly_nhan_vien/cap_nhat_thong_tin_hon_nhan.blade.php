          ...
          @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                <label for="gioi_tinh">Tình trạng hôn nhân</label>
                <select name="gioi_tinh" class="form-select" required>
                  <option value="Độc thân">Độc thân</option>
                  <option value="Đã kết hôn">Đã kết hôn</option>
                  <option value="Ly hôn">Ly hôn</option>
                  <option value="Góa chồng hoặc vợ">Góa chồng hoặc vợ</option>
                </select>
              </div>
              <div class="search-item d-inline-block w-25">
                <label for="so_con">Số con</label>
                <input type="number" name="so_con" class="form-control" placeholder="Nhập số con" required>
              </div>
            </div>
