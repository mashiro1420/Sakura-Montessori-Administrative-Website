      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Thêm môn học</h2>
          </div>
          <!-- Form to add new employee -->
          <form class="search-container" action="{{url('xl_dm_mon_hoc')}}" method="post">
          @csrf
            ...
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-outline-secondary ms-2" href="{{url('ql_dm_mon_hoc')}}">
