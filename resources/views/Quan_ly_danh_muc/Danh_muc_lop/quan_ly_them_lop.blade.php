      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Thêm lớp</h2>
          </div>
          ...
          @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                ...
                <input type="text" name="ten_lop" class="form-control" placeholder="Nhập tên lớp" required>
              </div>
            </div>  
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-outline-secondary ms-2" href="{{url('ql_dm_lop')}}">
