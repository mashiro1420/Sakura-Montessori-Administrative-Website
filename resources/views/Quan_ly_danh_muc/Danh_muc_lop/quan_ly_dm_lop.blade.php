...
<head>
  ...
  <title>Quản lý danh mục lớp</title>
...
<body>
      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Quản lý danh mục lớp</h2>
          </div>

          <!-- Search and Filter Section -->
          <!-- < class="search-container"> -->
          <form class="search-container" action="{{url('ql_dm_lop')}}" method="get">
            @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                <label for="ten_lop_search">Tên lớp</label>
                <input type="text" id="ten_lop_search" name = "tk_ten_lop" {{!empty($tk_ten_lop)?"value=$tk_ten_lop":""}} class="form-control" placeholder="Tìm kiếm tên lớp">
              </div>
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-primary" href="{{route('ql_them_lop')}}">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="action-column">
                    <a class="action-button" title="Chỉnh sửa" href="{{route('ql_sua_lop',['id' => $lop->id])}}"><i class="fa-solid fa-edit"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
  ...
  document.getElementById('reset-btn').addEventListener('click', function () {
    window.location.href = '{{ url("ql_dm_lop") }}';
  });
