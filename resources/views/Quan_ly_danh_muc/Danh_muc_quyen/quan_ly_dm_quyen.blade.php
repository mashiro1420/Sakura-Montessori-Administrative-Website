...
<body>
      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Quản lý danh mục quyền</h2>
          </div>

          <!-- Search and Filter Section -->
          <!-- < class="search-container"> -->
          <form class="search-container" action="{{url('ql_dm_quyen')}}" method="get">
            @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                <label for="ten_quyen_search">Tên quyền</label>
                <input type="text" id="ten_quyen_search" name = "tk_ten_quyen" {{!empty($tk_ten_quyen)?"value=$tk_ten_quyen":""}} class="form-control" placeholder="Tìm kiếm tên quyền">
              </div>
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-primary" href="{{route('ql_them_quyen')}}">
                  <i class="fa-solid fa-plus me-1"></i> Thêm quyền mới
                </a>
              </div>
            </div>
          </form>
  ...
  document.getElementById('reset-btn').addEventListener('click', function () {
    window.location.href = '{{ url("ql_dm_quyen") }}';
  });
