      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i>Cập nhật quyền</h2>
          </div>
          <!-- Form to add new employee -->
          <form class="search-container" action="{{url('xl_dm_quyen')}}" method="post">
          @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                <label for="id">Mã quyền</label>
                <input type="text" name="id" class="form-control" value="{{$quyen->id}}" readonly>
              </div>
              <div class="search-item d-inline-block w-25">
            ...
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-outline-secondary ms-2" href="{{url('ql_hs')}}">
                  <i class="fa-solid fa-arrow-left me-1"></i> Quay lại danh mục quyền
                </a>
              </div>
            </div>
          </form>
