...
<head>
  ...
  <title>Quản lý danh mục khối</title>
...
<body>
      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Quản lý danh mục khối</h2>
          </div>

          <!-- Search and Filter Section -->
          <!-- < class="search-container"> -->
          <form class="search-container" action="{{url('ql_dm_khoi')}}" method="get">
            @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                <label for="ten_khoi_search">Tên khối</label>
                <input type="text" id="ten_khoi_search" name = "tk_ten_khoi" {{!empty($tk_ten_khoi)?"value=$tk_ten_khoi":""}} class="form-control" placeholder="Tìm kiếm tên khối">
              </div>
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-primary" href="{{route('ql_them_khoi')}}">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="action-column">
                    <a class="action-button" title="Chỉnh sửa" href="{{route('ql_sua_khoi',['id' => $khoi->id])}}"><i class="fa-solid fa-edit"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
  ...
  document.getElementById('reset-btn').addEventListener('click', function () {
    window.location.href = '{{ url("ql_dm_khoi") }}';
  });
