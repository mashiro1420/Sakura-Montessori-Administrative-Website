      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Thêm phòng học</h2>
          </div>
          ...
          @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                ...
                <input type="text" name="ten_phong_hoc" class="form-control" placeholder="Nhập tên phòng học" required>
              </div>
              <div class="search-item d-inline-block w-25">
                <label for="so_tang">Số tầng</label>
                <input type="number" name="so_tang" class="form-control" placeholder="Nhập số tầng" required>
              </div>
              <div class="search-item d-inline-block w-25">
                <label for="suc_chua">Sức chứa</label>
                <input type="number" name="suc_chua" class="form-control" placeholder="Nhập sức chứa" required>
              </div>
            </div>  
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-outline-secondary ms-2" href="{{url('ql_dm_phong_hoc')}}">
                  <i class="fa-solid fa-arrow-left me-1"></i> Quay lại danh mục phòng học
                </a>
              </div>
            </div>
          </form>
