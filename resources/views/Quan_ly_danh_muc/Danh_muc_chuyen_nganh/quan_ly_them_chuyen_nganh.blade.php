      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Thêm chuyên ngành</h2>
          </div>
          ...
          @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                ...
                <input type="text" name="ten_chuyen_nganh" class="form-control" placeholder="Nhập tên chuyên ngành" required>
              </div>
            </div>  
            <div class="action-buttons">
              ...
              <div>
                <a class="btn btn-outline-secondary ms-2" href="{{url('ql_dm_chuyen_nganh')}}">
