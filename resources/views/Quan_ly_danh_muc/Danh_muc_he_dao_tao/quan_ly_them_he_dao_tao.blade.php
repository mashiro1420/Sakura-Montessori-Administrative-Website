      ...
      <div class="content" id="content" style="margin-left: 70px;">
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2><i class="fa-solid fa-chalkboard-user"></i> Thêm hệ đào tạo</h2>
          </div>
          ...
          @csrf
            <div class="filter-row">
              <div class="search-item d-inline-block w-25">
                ...
                <input type="text" name="ten_he_dao_tao" class="form-control" placeholder="Nhập tên hệ đào tạo" required>
              </div>
            </div>  
