...
<body>
          ...
          @csrf
            <div class="filter-row">
              ...
              <div class="search-item d-inline-block w-25">
                ...
                <input type="text" name="ten_gia" class="form-control" placeholder="Nhập tên dịch vụ" required>
              </div>
              <div class="search-item d-inline-block w-25">
                <label for="gia">Giá</label>
                <input type="int" name="gia" class="form-control" required>
              </div>
              <div class="search-item d-inline-block w-25">
  ...
  // Nút làm mới phần thêm bảng giá
