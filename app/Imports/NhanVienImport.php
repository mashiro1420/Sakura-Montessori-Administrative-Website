...
class NhanVienImport implements ToModel,WithHeadingRow
{
    ...
    {
        // $chuyen_nganh = !empty(ChuyenNganhModel::where('ten_chuyen_nganh',$row['chuyen_nganh'])->first())?ChuyenNganhModel::where('ten_chuyen_nganh',$row['chuyen_nganh'])->first()->id:null;
        // dd($chuyen_nganh);
        ...
        ],['id','cmnd'], ['ho_ten', 'gioi_tinh', 'noi_sinh', 'ngay_sinh', 'ngay_vao_lam', 'ngay_cap', 'noi_cap', 'dan_toc', 'ton_giao', 'quoc_tich']);

        TTHonNhanModel::upsert([
            'id_nhan_vien' => $row['ma_nhan_vien'],
            'tinh_trang_hon_nhan' => $row['tinh_trang_hon_nhan'],
            'so_con' => $row['so_con'],
        ],['id_nhan_vien'], ['tinh_trang_hon_nhan', 'so_con']);
        ...
        ],['id_nhan_vien'], ['sdt_rieng', 'sdt_noi_bo', 'email_noi_bo', 'email_rieng']);
        ...
        TTBangCapModel::upsert([
            ...
            'id_chuyen_nganh' => !empty(ChuyenNganhModel::where('ten_chuyen_nganh',$row['chuyen_nganh'])->first())?ChuyenNganhModel::where('ten_chuyen_nganh',$row['chuyen_nganh'])->first()->id:null,
            'xep_loai' => $row['xep_loai_tdcm'],
            'nam_tot_nghiep' => $row['nam_tot_nghiep'],
        ],['id_nhan_vien'], ['id_chuyen_nganh','trinh_do_hoc_van', 'trinh_do_chuyen_mon', 'trinh_do_chinh', 'hinh_thuc_dao_tao', 'chung_chi', 'montessori', 'truong_dao_tao', 'xep_loai', 'nam_tot_nghiep']);
        ...
        ],['id_nhan_vien'], ['so_bhxh', 'thang_tham_gia_bhxh', 'ma_so_thue', 'thuong_tru', 'tam_tru', 'khai_sinh']);
        ...
        ],['id_nhan_vien'], ['loai_hd', 'so_hd', 'ngay_ky', 'ngay_ket_thuc']);
